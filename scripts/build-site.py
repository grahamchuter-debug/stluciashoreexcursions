  ...
  <div class="wrap booking-shell">
    ...
    <div class="booking-panel">
      ...
      <div class="booking-status-banner" id="booking-status-banner" role="status">
        ...
        <p id="booking-status-body">Payment receives your request — it does not confirm the excursion. Live card payments are not enabled yet.</p>
      </div>
      <form class="booking-form" id="sl-booking-form" method="post" action="#" data-product-id="{product["id"]}" data-live="0" novalidate>
        <fieldset class="booking-fieldset">
        ...
        <div class="booking-actions">
          ...
          <button type="button" class="btn btn--solid" disabled title="Live checkout is locked" id="booking-submit-locked">Checkout locked — opening soon</button>
          <button type="submit" class="btn btn--solid" id="booking-submit" hidden>Pay &amp; request</button>
        </div>
        <p class="help" id="booking-footer-note">Live payments remain locked on this product. Prefer to ask first? <a href="mailto:{EMAIL}">{EMAIL}</a></p>
      </form>
    </div>
  </div>
</section>
